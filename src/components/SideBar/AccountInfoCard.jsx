...
import { EllipsisHorizontalOutline, EllipsisHorizontal } from 'react-ionicons'

const AccountInfoCard = () => {
    return (
        <div className="h-[50px] w-full bg-gray-300 flex px-4 items-center justify-between">
            <div className="flex gap-2">
                <img src="https://google.com/image.png" alt="User Image" className="h-[30px] w-[30px] rounded-full bg-blue-300" />
